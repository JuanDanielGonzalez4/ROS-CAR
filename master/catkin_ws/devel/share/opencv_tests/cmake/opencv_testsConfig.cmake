...
set(opencv_tests_SOURCE_PREFIX /home/test/catkin_ws/src/vision_opencv/opencv_tests)
set(opencv_tests_DEVEL_PREFIX /home/test/catkin_ws/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'opencv_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/test/catkin_ws/src/vision_opencv/opencv_tests/${idir}'.  ${_report}")
    endif()
